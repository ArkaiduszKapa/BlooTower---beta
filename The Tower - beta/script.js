  document.addEventListener('DOMContentLoaded', function() {
    ...
    class Crystal extends Item{
      constructor(name,id,value, type,size){
        super(name,id,value);
        this.type = type;
        this.size = size;
      }
    ...
    const MosnterDrops = {
      s_c_crystal: new Crystal('chunk of small colorless crystal', 210 , 12, 'MonsterDrop','small'),
      s_m_crystal: new Crystal('chunk of medium colorless crystal', 220 , 40, 'MonsterDrop','medium'),
    };
    const small_colorless_crystal = {
      id: 210,
      name: 'chunk of small colorless crystal',
      type: 'MonsterDrop',
      description: 'drop from weak mosnter',
      value: 12,
    };
    //id (floor)(,region- tower is 0),(0-the worst loot to the best loot)
  ...
  //mobs:
    ...
    class equipment{
      constructor() {
        this.container = document.getElementById("bottom_eq");
        this.inventory = [];
      }
    }
    ...
    class Game {
      constructor() {
        ...
        healButton.addEventListener('click', function() {
          for(let key in MosnterDrops){
            let crystal = MosnterDrops[key];
            console.log(`Name: ${crystal.name}, ID: ${crystal.id}, Value: ${crystal.value}, Type: ${crystal.type}, Size: ${crystal.size}`);
        }
        });
